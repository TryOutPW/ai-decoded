...
// ─── STYLES ──────────────────────────────────────────────────────────────────
const css = `@import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@400;500&family=Playfair+Display:wght@400;700&display=swap'); *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;} :root{--bg:#08090d;--s1:#0f1117;--s2:#161b24;--b1:#1a2030;--b2:#242e40;--t1:#dde6f0;--t2:#7a8a9e;--t3:#3a4558;--fd:'Playfair Display',Georgia,serif;--fm:'DM Mono',monospace;--r:10px;--tr:.18s ease;} .light{--bg:#f4f5f7;--s1:#ffffff;--s2:#eef0f3;--b1:#d8dce4;--b2:#c4c9d4;--t1:#0f1117;--t2:#4a5568;--t3:#9aa3b0;} body,#root{font-family:var(--fm);background:var(--bg);color:var(--t1);height:100vh;} .app{display:flex;flex-direction:column;height:100vh;overflow:hidden;background:var(--bg);} /* ── Header (title + toggles) ── */ .header{flex-shrink:0;height:48px;background:var(--s1);border-bottom:1px solid var(--b1);display:flex;align-items:center;padding:0 18px;gap:12px;} .header-brand{flex:1;min-width:0;overflow:hidden;} .header-brand h1{font-family:var(--fd);font-size:1rem;font-weight:700;color:var(--t1);line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;} .header-brand p{font-size:.5rem;color:var(--t3);margin-top:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;} .header-right{display:flex;align-items:center;gap:8px;flex-shrink:0;} .tg-lbl{font-size:.52rem;color:var(--t3);} .tg{display:flex;border-radius:5px;overflow:hidden;border:1px solid var(--b2);background:var(--bg);} .tb{padding:4px 10px;background:transparent;border:none;color:var(--t2);font-family:var(--fm);font-size:.63rem;cursor:pointer;transition:all var(--tr);} .tb.on{background:var(--s2);color:var(--t1);} /* ── Main content ── */ .main{flex:1;overflow-y:auto;padding-bottom:4px;} /* ── Bottom tab bar ── */ .bottomnav{flex-shrink:0;height:58px;background:var(--s1);border-top:1px solid var(--b1);display:flex;align-items:stretch;} .ni{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;cursor:pointer;font-size:.6rem;color:var(--t3);transition:all var(--tr);padding:6px 4px;border:none;background:none;font-family:var(--fm);} .ni:hover{color:var(--t2);} .ni.on{color:var(--t1);} .ni-icon{font-size:1.6rem;line-height:1;} .ni-bar{position:absolute;top:0;left:20%;right:20%;height:2px;background:var(--c,var(--t1));border-radius:0 0 2px 2px;opacity:0;transition:opacity var(--tr);} .ni{position:relative;} .ni.on .ni-bar{opacity:1;} .sh{padding:20px 24px 13px;border-bottom:1px solid var(--b1);margin-bottom:20px;} .sh h2{font-family:var(--fd);font-size:1.5rem;font-weight:700;color:var(--t1);} .sh p{color:var(--t2);font-size:.7rem;margin-top:4px;line-height:1.5;} /* MAP */ .mwrap{padding:12px 24px 24px;} .msvg{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);width:100%;display:block;} /* GRID */ .cgrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(185px,1fr));gap:10px;padding:0 24px 24px;} .cc{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:14px;cursor:pointer;transition:all var(--tr);position:relative;overflow:hidden;} .cc::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:var(--c,#fff);opacity:.4;transition:opacity var(--tr);} .cc:hover{border-color:var(--b2);transform:translateY(-1px);} .cc:hover::before{opacity:1;} .cc-icon{font-size:.58rem;font-weight:700;padding:2px 5px;border-radius:3px;display:inline-block;margin-bottom:8px;border:1px solid currentColor;} .cc-label{font-family:var(--fd);font-size:.9rem;font-weight:700;margin-bottom:2px;} .cc-short{font-size:.63rem;color:var(--t2);} /* DETAIL */ .cd{padding:0 24px 32px;} .back{background:none;border:none;font-family:var(--fm);font-size:.66rem;color:var(--t3);cursor:pointer;margin-bottom:14px;display:block;transition:color var(--tr);} .back:hover{color:var(--t2);} .dh{display:flex;align-items:flex-start;gap:12px;margin-bottom:20px;} .dh-ic{width:44px;height:44px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:.58rem;font-weight:700;flex-shrink:0;border:1px solid var(--b2);} .dh h2{font-family:var(--fd);font-size:1.5rem;font-weight:700;line-height:1.05;} .dh .dsub{color:var(--t2);font-size:.68rem;margin-top:2px;} .dgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:13px;} .dc{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:13px;} .dc h4{font-size:.56rem;text-transform:uppercase;letter-spacing:.1em;color:var(--t3);margin-bottom:7px;} .dc p{font-size:.69rem;line-height:1.65;color:var(--t2);} .fl{list-style:none;} .fl li{display:flex;gap:7px;font-size:.68rem;padding:5px 0;border-bottom:1px solid var(--b1);color:var(--t2);} .fl li:last-child{border-bottom:none;} .fk{color:var(--t3);min-width:65px;flex-shrink:0;font-size:.64rem;} .wt{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:13px;margin-bottom:13px;} .wt h4{font-size:.56rem;text-transform:uppercase;letter-spacing:.1em;color:var(--t3);margin-bottom:10px;} .wts-item{display:flex;align-items:flex-start;gap:9px;padding:7px 0;border-bottom:1px solid var(--b1);opacity:.28;transition:opacity .4s;} .wts-item:last-child{border-bottom:none;} .wts-item.on{opacity:1;} .wn{width:18px;height:18px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.58rem;flex-shrink:0;border:1px solid var(--b2);color:var(--t3);} .wts-item.on .wn{border-color:var(--c,#fff);color:var(--c,#fff);} .wtext{font-size:.68rem;color:var(--t2);padding-top:1px;line-height:1.5;} .wctrl{display:flex;gap:5px;margin-top:10px;} .uw{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);overflow:hidden;margin-bottom:13px;} .uw-head{display:flex;border-bottom:1px solid var(--b1);} .uwt{padding:8px 13px;cursor:pointer;font-size:.66rem;color:var(--t3);border-bottom:2px solid transparent;background:none;border-top:none;border-left:none;border-right:none;font-family:var(--fm);transition:all var(--tr);} .uwt.on{color:var(--t1);border-bottom-color:var(--c,#fff);} .uw-body{padding:13px;} .uw-acc{font-size:.62rem;color:var(--t3);margin-bottom:7px;} .uw-acc span{color:var(--t2);} .exbox{background:var(--bg);border:1px solid var(--b1);border-radius:5px;padding:9px;font-size:.66rem;color:var(--t2);margin-bottom:8px;line-height:1.6;} .sl{list-style:none;} .sl li{display:flex;gap:6px;font-size:.66rem;color:var(--t2);padding:4px 0;border-bottom:1px solid var(--b1);} .sl li:last-child{border-bottom:none;} .sn{color:var(--t3);flex-shrink:0;} .rtags{display:flex;gap:5px;flex-wrap:wrap;margin-top:5px;} .rtag{font-size:.6rem;padding:2px 7px;border-radius:3px;border:1px solid var(--b2);color:var(--t3);cursor:pointer;background:none;font-family:var(--fm);transition:all var(--tr);} .rtag:hover{color:var(--t1);} .try-cta{margin-top:14px;padding:10px;background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;} .try-cta p{font-size:.68rem;color:var(--t2);} /* BUTTONS */ .btn{padding:6px 12px;border-radius:6px;border:1px solid var(--b2);background:var(--s2);color:var(--t1);font-family:var(--fm);font-size:.66rem;cursor:pointer;transition:all var(--tr);display:inline-flex;align-items:center;gap:4px;} .btn:hover{border-color:var(--t3);} .btn:disabled{opacity:.4;cursor:not-allowed;} .btn-p{background:var(--t1);color:var(--bg);border-color:var(--t1);} .btn-p:hover{opacity:.88;} .btn-a{border-color:var(--c,#fff);color:var(--c,#fff);} .btn-a:hover{background:color-mix(in srgb,var(--c,#fff) 10%,transparent);} .btn-sm{padding:4px 9px;font-size:.61rem;} /* PLAYGROUND */ .pg{padding:0 24px 24px;} .pt{display:flex;align-items:center;gap:8px;margin-bottom:14px;flex-wrap:wrap;} .csel{background:var(--s1);border:1px solid var(--b2);color:var(--t1);font-family:var(--fm);font-size:.68rem;padding:6px 9px;border-radius:6px;cursor:pointer;min-width:145px;} .play-lay{display:grid;grid-template-columns:1fr 260px;gap:10px;} .chat{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);display:flex;flex-direction:column;height:450px;} .cmsgs{flex:1;overflow-y:auto;padding:13px;display:flex;flex-direction:column;gap:10px;} .cmsg{display:flex;gap:6px;align-items:flex-start;} .cmsg.user{flex-direction:row-reverse;} .cav{width:21px;height:21px;border-radius:50%;background:var(--s2);border:1px solid var(--b2);display:flex;align-items:center;justify-content:center;font-size:.56rem;flex-shrink:0;color:var(--t3);} .cbub{max-width:80%;padding:7px 10px;border-radius:8px;font-size:.68rem;line-height:1.6;} .cmsg.assistant .cbub{background:var(--s2);border:1px solid var(--b1);color:var(--t2);border-radius:3px 8px 8px 8px;} .cmsg.user .cbub{background:var(--s2);border:1px solid var(--b2);color:var(--t1);border-radius:8px 3px 8px 8px;} .cinrow{padding:8px;border-top:1px solid var(--b1);display:flex;gap:6px;} .cin{flex:1;background:var(--bg);border:1px solid var(--b2);border-radius:5px;padding:7px 8px;color:var(--t1);font-family:var(--fm);font-size:.68rem;outline:none;resize:none;height:34px;transition:border-color var(--tr);} .cin:focus{border-color:var(--t3);} .scen{display:flex;flex-direction:column;gap:6px;} .scen h4{font-size:.56rem;text-transform:uppercase;letter-spacing:.1em;color:var(--t3);} .sbtn{background:var(--s1);border:1px solid var(--b1);border-radius:5px;padding:8px;cursor:pointer;text-align:left;transition:all var(--tr);color:var(--t2);font-family:var(--fm);font-size:.66rem;line-height:1.4;} .sbtn:hover{border-color:var(--b2);color:var(--t1);} .cpbox{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:14px;height:450px;overflow-y:auto;} .cprompt{background:var(--bg);border:1px solid var(--b2);border-left:3px solid #14B8A6;border-radius:5px;padding:9px;font-size:.66rem;color:var(--t2);line-height:1.6;margin:7px 0;white-space:pre-wrap;} /* TOOLS */ .ts{padding:0 24px 24px;} .ftls{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px;} .ftc{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:16px;cursor:pointer;transition:all var(--tr);position:relative;} .ftc:hover{border-color:var(--b2);} .fbadge{position:absolute;top:9px;right:9px;font-size:.52rem;text-transform:uppercase;letter-spacing:.08em;padding:2px 5px;border-radius:3px;background:var(--s2);color:var(--t3);border:1px solid var(--b2);} .ftc h3{font-family:var(--fd);font-size:1.05rem;font-weight:700;margin-bottom:3px;} .ftc p{font-size:.66rem;color:var(--t2);margin-bottom:10px;} .tfilts{display:flex;gap:5px;margin-bottom:13px;flex-wrap:wrap;} .fchip{padding:3px 10px;border-radius:12px;border:1px solid var(--b2);background:transparent;color:var(--t3);font-family:var(--fm);font-size:.61rem;cursor:pointer;transition:all var(--tr);} .fchip.on{background:var(--s2);color:var(--t1);border-color:var(--t3);} .tgrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(165px,1fr));gap:8px;} .tc{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:12px;cursor:pointer;transition:all var(--tr);} .tc:hover{border-color:var(--b2);} .tn{font-family:var(--fd);font-size:.85rem;font-weight:700;margin-bottom:2px;} .tt{font-size:.61rem;color:var(--t2);margin-bottom:6px;} .tmeta{display:flex;gap:4px;flex-wrap:wrap;} .tchip{font-size:.51rem;padding:2px 5px;border-radius:3px;background:var(--s2);color:var(--t3);border:1px solid var(--b1);} .cb{color:#10B981;border-color:#10B981;}.ci{color:#F59E0B;border-color:#F59E0B;}.ca{color:#EC4899;border-color:#EC4899;} .overlay{position:fixed;inset:0;z-index:100;background:rgba(0,0,0,.78);backdrop-filter:blur(5px);display:flex;align-items:center;justify-content:center;padding:20px;} .opanel{background:var(--s1);border:1px solid var(--b2);border-radius:12px;padding:22px;max-width:450px;width:100%;max-height:80vh;overflow-y:auto;position:relative;} .xbtn{position:absolute;top:10px;right:10px;background:var(--s2);border:1px solid var(--b2);color:var(--t3);width:26px;height:26px;border-radius:50%;cursor:pointer;font-size:.72rem;display:flex;align-items:center;justify-content:center;transition:all var(--tr);} .xbtn:hover{color:var(--t1);} .ws-box{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:13px;margin-bottom:16px;} /* DOTS */ .dots{display:flex;gap:3px;padding:2px 0;} .dots span{width:5px;height:5px;border-radius:50%;background:var(--t3);animation:blink 1.2s infinite;} .dots span:nth-child(2){animation-delay:.2s;} .dots span:nth-child(3){animation-delay:.4s;} @keyframes blink{0%,80%,100%{opacity:.3;}40%{opacity:1;}} /* EXAMPLE SECTION */ .ex-wrap{padding:0 24px 40px;} .ex-scenario{background:var(--s1);border:1px solid var(--b1);border-left:3px solid #7C3AED;border-radius:var(--r);padding:16px;margin-bottom:22px;} .ex-scenario h4{font-size:.58rem;text-transform:uppercase;letter-spacing:.1em;color:#7C3AED;margin-bottom:7px;} .ex-scenario p{font-size:.73rem;color:var(--t1);line-height:1.7;} .ex-section-title{font-family:var(--fd);font-size:1.05rem;font-weight:700;color:var(--t1);margin-bottom:13px;} .ex-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(265px,1fr));gap:11px;margin-bottom:26px;} .ex-card{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:14px;position:relative;overflow:hidden;transition:all var(--tr);} .ex-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:var(--c);opacity:.5;} .ex-card:hover{border-color:var(--b2);} .ex-card-top{display:flex;align-items:center;gap:9px;margin-bottom:8px;} .ex-badge{font-size:.55rem;font-weight:700;padding:2px 5px;border-radius:3px;border:1px solid currentColor;font-family:var(--fm);} .ex-card-label{font-family:var(--fd);font-size:.95rem;font-weight:700;color:var(--t1);} .ex-role{font-size:.62rem;color:var(--t3);margin-bottom:5px;text-transform:uppercase;letter-spacing:.07em;} .ex-contrib{font-size:.67rem;color:var(--t2);line-height:1.6;white-space:pre-line;margin-bottom:10px;} .flow-section{margin-bottom:24px;} .flow-steps{display:flex;flex-direction:column;} .flow-step{display:flex;align-items:flex-start;gap:11px;padding:9px 0;border-bottom:1px solid var(--b1);} .flow-step:last-child{border-bottom:none;} .flow-num{width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.58rem;font-weight:700;flex-shrink:0;border:1px solid currentColor;font-family:var(--fm);} .flow-label{font-size:.7rem;color:var(--t1);line-height:1.4;flex:1;} .flow-badge{font-size:.55rem;padding:1px 5px;border-radius:3px;border:1px solid currentColor;font-family:var(--fm);margin-left:5px;vertical-align:middle;white-space:nowrap;} .outcome-section{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:16px;margin-bottom:18px;} .outcome-section h3{font-family:var(--fd);font-size:.95rem;font-weight:700;margin-bottom:10px;} .outcome-item{display:flex;gap:7px;font-size:.68rem;color:var(--t2);padding:5px 0;border-bottom:1px solid var(--b1);line-height:1.5;} .outcome-item:last-child{border-bottom:none;} .outcome-check{color:#10B981;flex-shrink:0;font-weight:700;} /* EXAMPLE SWITCHER */ .ex-tabs{display:flex;gap:0;margin-bottom:22px;border:1px solid var(--b1);border-radius:var(--r);overflow:hidden;} .ex-tab{flex:1;padding:10px 8px;cursor:pointer;font-size:.66rem;color:var(--t3);background:none;border:none;font-family:var(--fm);transition:all var(--tr);text-align:center;line-height:1.3;border-right:1px solid var(--b1);} .ex-tab:last-child{border-right:none;} .ex-tab:hover{color:var(--t2);background:var(--s2);} .ex-tab.on{color:var(--t1);background:var(--s2);} .ex-tab-icon{display:block;font-size:1rem;margin-bottom:3px;} .ex-concepts-used{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:18px;} .ex-concept-pill{font-size:.6rem;padding:3px 8px;border-radius:4px;border:1px solid currentColor;font-family:var(--fm);} /* BUILD YOUR SETUP */ .build-box{background:var(--s1);border:1px solid var(--b1);border-radius:var(--r);padding:20px;margin-bottom:24px;} .build-box h3{font-family:var(--fd);font-size:1.05rem;font-weight:700;color:var(--t1);margin-bottom:5px;} .build-box p{font-size:.7rem;color:var(--t2);margin-bottom:14px;line-height:1.5;} .build-input{width:100%;background:var(--bg);border:1px solid var(--b2);border-radius:7px;padding:11px 13px;color:var(--t1);font-family:var(--fm);font-size:.73rem;outline:none;resize:none;height:80px;transition:border-color var(--tr);line-height:1.5;} .build-input:focus{border-color:var(--t3);} .build-result{margin-top:18px;display:flex;flex-direction:column;gap:14px;} .build-section-label{font-size:.58rem;text-transform:uppercase;letter-spacing:.1em;color:var(--t3);margin-bottom:8px;} .build-concept-chips{display:flex;flex-wrap:wrap;gap:7px;} .build-chip{display:flex;align-items:center;gap:6px;padding:5px 11px;border-radius:6px;border:1px solid currentColor;font-size:.68rem;font-family:var(--fm);} .build-chip-skip{opacity:.35;border-style:dashed;} .build-plan{background:var(--bg);border:1px solid var(--b1);border-radius:8px;padding:14px;} .build-plan-step{display:flex;gap:10px;padding:8px 0;border-bottom:1px solid var(--b1);font-size:.71rem;color:var(--t2);line-height:1.5;} .build-plan-step:last-child{border-bottom:none;} .build-plan-num{font-weight:700;flex-shrink:0;min-width:18px;} /* PROMPT OVERLAY */ .prompt-overlay{position:fixed;inset:0;z-index:200;background:rgba(0,0,0,.82);backdrop-filter:blur(6px);display:flex;align-items:center;justify-content:center;padding:20px;} .prompt-panel{background:var(--s1);border:1px solid var(--b2);border-radius:12px;padding:22px;max-width:560px;width:100%;max-height:85vh;overflow-y:auto;position:relative;} .prompt-pre{background:var(--bg);border:1px solid var(--b1);border-radius:6px;padding:13px;font-size:.67rem;color:var(--t2);line-height:1.75;white-space:pre-wrap;margin:11px 0;font-family:var(--fm);} ::-webkit-scrollbar{width:3px;} ::-webkit-scrollbar-track{background:transparent;} ::-webkit-scrollbar-thumb{background:var(--b2);border-radius:2px;}`;
...
<button className=“tb” style={{background:“var(–s2)”,border:“1px solid var(–b2)”,borderRadius:5,padding:“4px 8px”,cursor:“pointer”,color:“var(–t2)”,display:“flex”,alignItems:“center”,justifyContent:“center”,width:30,height:28}} onClick={() => setDarkMode(d => !d)}>
{darkMode ? (
